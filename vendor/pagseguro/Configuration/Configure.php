...
namespace vendor\pagseguro\Configuration;

use vendor\pagseguro\Domains\AccountCredentials;
use vendor\pagseguro\Domains\ApplicationCredentials;
use vendor\pagseguro\Domains\Charset;
use vendor\pagseguro\Domains\Environment;
use vendor\pagseguro\Domains\Log;
use vendor\pagseguro\Resources\Responsibility;

/**
 * Class Configure
 * @package vendor\pagseguro\Configuration
 */
class Configure
{
