...
namespace vendor\pagseguro\Parsers\Authorization\Search\Date;

/**
 * Class Response
 * @package vendor\pagseguro\Parsers\Transaction\Search\Date
 */
/**
 * Class Response
 * @package vendor\pagseguro\Parsers\Authorization\Search\Date
 */
class Response
{
    /**
    ...
    {
        $response = new \vendor\pagseguro\Parsers\Authorization\Search\Response();
