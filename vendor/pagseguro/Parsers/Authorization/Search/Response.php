...
namespace vendor\pagseguro\Parsers\Authorization\Search;

use vendor\pagseguro\Domains\Account;
use vendor\pagseguro\Domains\Permission;

/**
 * Class Authorization
 * @package vendor\pagseguro\Parsers\Authorization\Search
 */
class Response
{
