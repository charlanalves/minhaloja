...
namespace vendor\pagseguro\Parsers\Checkout;

use vendor\pagseguro\Enum\Properties\Current;
use vendor\pagseguro\Parsers\Accepted;
...
use vendor\pagseguro\Parsers\PaymentMethod;
use vendor\pagseguro\Parsers\PreApproval;
use vendor\pagseguro\Parsers\Sender;
use vendor\pagseguro\Parsers\Shipping;
use vendor\pagseguro\Parsers\Metadata;
use vendor\pagseguro\Parsers\Parameter;
...
class Request extends Error implements Parser
{
     ...
     * @return array
     */
    public static function getData(\vendor\pagseguro\Domains\Requests\Payment $payment)
    {
        $data = [];
