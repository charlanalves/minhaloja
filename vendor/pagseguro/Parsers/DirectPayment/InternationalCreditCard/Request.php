...
namespace vendor\pagseguro\Parsers\DirectPayment\InternationalCreditCard;
...
use vendor\pagseguro\Parsers\DirectPayment\CreditCard\Method;
...
use vendor\pagseguro\Parsers\Transaction\InternationalCreditCard\Response;
...
class Request extends Error implements Parser
{
     ...
     * @return array
     */
    public static function getData(\vendor\pagseguro\Domains\Requests\Requests $creditCard)
    {
        $data = [];
