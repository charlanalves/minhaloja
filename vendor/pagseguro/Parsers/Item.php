        ...
        if ($request->itemLenght() > 0) {
            ...
            foreach ($items as $key => $value) {
                ...
                if ($items[$key]->getAmount() != null) {
                    $amount = \vendor\pagseguro\Helpers\Currency::toDecimal($items[$key]->getAmount());
                ...
                if ($items[$key]->getShippingCost() != null) {
                    $data[sprintf($properties::ITEM_SHIPPING_COST, $count)] = \vendor\pagseguro\Helpers\Currency::toDecimal(
