...
namespace vendor\pagseguro\Parsers\Response;

use vendor\pagseguro\Resources\Factory\Shipping\Address;
use vendor\pagseguro\Resources\Factory\Shipping\Cost;
use vendor\pagseguro\Resources\Factory\Shipping\Type;

/**
 * Class Shipping
 * @package vendor\pagseguro\Parsers\Response
 */
trait Shipping
{
    ...
    {
        $shippingClass = new \vendor\pagseguro\Domains\Shipping();
