...
namespace vendor\pagseguro\Services\Transactions;
...
/**
 * Class Notifications
 * @package vendor\pagseguro\Services\Transactions
 */
class Notification
{
    ...
    public static function check(Credentials $credentials)
    {
        ...
        try {
            ...
            $response = Responsibility::http(
                $http,
                new \vendor\pagseguro\Parsers\Transaction\Notification\Request
            );
            Logger::info(
                sprintf(
                    "Date: %s, Code: %s",
