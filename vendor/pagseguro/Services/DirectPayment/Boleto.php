...
use vendor\pagseguro\Parsers\DirectPayment\Boleto\Request;
...
class Boleto
{
     ...
     * @param \vendor\pagseguro\Domains\Requests\DirectPayment\Boleto $payment
     * @return string
     * @throws \Exception
     */
    public static function checkout(
        Credentials $credentials,
        \vendor\pagseguro\Domains\Requests\DirectPayment\Boleto $payment
    ) {
