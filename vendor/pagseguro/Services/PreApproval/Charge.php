...
namespace vendor\pagseguro\Services\PreApproval;
...
use vendor\pagseguro\Parsers\PreApproval\Charge\Request;
use vendor\pagseguro\Resources\Responsibility;

class Charge
{

    public static function create(Credentials $credentials, \vendor\pagseguro\Domains\Requests\PreApproval\Charge $charge)
    {
