        ...
        <header id="header" class="height-top">
            ...
            <div class="widget-body">
                <ul id="myTab1" class="nav nav-tabs bordered">
                    <li class="active">
                        <a href="#s1" data-toggle="tab"><i class="fa fa-fw fa-lg fa-tags"></i>Produtos <span class="badge bg-color-red txt-color-white">12</span></a>
                    </li> 
                    <li>
                        <a href="#s2" data-toggle="tab"><i class="fa fa-fw fa-lg fa-check-square-o"></i> Meus pedidos</a>
                    </li>
                </ul>
            </div>
            <!-- end widget content -->
